...
-- Schema mapaDaDesordem
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS  "mapaDaDesordem"  ;
...
CREATE TABLE  "public"."DENUNCIA" (
  ...
  "DEN_DATAORA_OCORREU" TIMESTAMP NOT NULL,
  "DEN_DATAHORA_SOLUCAO" TIMESTAMP NOT NULL,
  ...
  "DEN_ANONIMATO" SMALLINT NOT NULL,
